  ...
  buttons() {
    return [<ButtonGroup>
      <Buttons.Cancel data-test-id="button-cancel" ajaxOperationMonitor={this.ajaxOperationMonitor}
                      onclick={(e: MouseEvent) => this.close()}>取消</Buttons.Cancel>
      <Buttons.Primary data-test-id="button-save"
                       ajaxOperationMonitor={this.ajaxOperationMonitor}
                       ajaxOperation={this.validateAndPerformSave.bind(this)}>保存</Buttons.Primary>
  ...
  buttons() {
    return [<ButtonGroup>
      ...
      <Buttons.Primary data-test-id="button-save"
                       ...
                       disabled={this.isStale()}>保存</Buttons.Primary>
      {this.saveFailureIdentifier}
    </ButtonGroup>];
  }
